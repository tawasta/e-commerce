...
* Changes during v17 -> v19 migration:
  - views/templates.xml: Updated xpath from <a> to <button> to correspond 
  to the v19 element
  - views/templates.xml: "Hide cart button" template updated to inherit 
  website_sale.cta_wrapper instead of website_sale.product.
  - static/src/js/product_cant_order.js: rewritten to use v19 compatible JS syntax. 
  Logic remains the same.
  - Changed CheckProduct functions type from json to jsonrpc to match v19 API. 
