...
class ResConfigSettings(models.TransientModel):
    ...
    website_sale_add_explanation_text = fields.Html(string="Website sale: add an explanation", related="website_id.add_explanation_text", readonly=False, translate=True)
