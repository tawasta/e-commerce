odoo.define('website_sale_find_closest_stock_move.customVariantMixin', function (require) {
'use strict';
...
publicWidget.registry.WebsiteSale.include({
    ...
    _customOnChangeCombinationStock: function (ev, $parent, combination) {
        ...
        if (combination.product_type === 'product' && _.contains(['delivery_time'], combination.inventory_availability)) {
