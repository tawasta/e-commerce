...
[![Pre-commit Status](https://github.com/tawasta/e-commerce/actions/workflows/pre-commit.yml/badge.svg?branch=17.0)](https://github.com/tawasta/e-commerce/actions/workflows/pre-commit.yml?query=branch%3A17.0)

Website sale (e-commerce) modules
=================================
...
[website_sale_address_form_custom_names](website_sale_address_form_custom_names/) | 17.0.1.0.0 |  | Customize address form labels on the website checkout.
...
[website_sale_limit_payment_providers](website_sale_limit_payment_providers/) | 17.0.1.2.1 |  | Limit payment providers by product
